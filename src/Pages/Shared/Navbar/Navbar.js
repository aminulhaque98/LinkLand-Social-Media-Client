    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <Link to="/" className="lg:text-xl lg:font-bold"><span className='text-purple-600'>LinkLand</span> <span className='text-pink-600 lg:text-2xl lg:font-bold italic'>Social</span> Media</Link>
            </div>
